  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Clínica Odontológica</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                ...
                <small class="float-right"><a href="add_dist.php"> <button type="button" class="btn btn-block btn-primary">Adicionar Paciente</button></a>    </small>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $stmt = $conn->prepare("SELECT * FROM clinica");
                    $stmt->execute();
